...
export function Navbar({ currentPage, onNavigate }: NavbarProps) {
  ...
  // Mock notifications
  const notifications = [
    { id: '1', text: 'Your feedback has been reviewed', time: '2 hours ago', read: false },
    { id: '2', text: 'New response to your feedback', time: '1 day ago', read: false },
    { id: '3', text: 'Weekly campus feedback digest is ready', time: '2 days ago', read: true },
  ]
              ...
              {user && (
                <form onSubmit={handleSearch} className="relative">
                  <input
                    ...
                    className={`w-48 pl-10 pr-4 py-2 rounded-xl text-sm transition-all ${
                      scrolled
                    ...
                    <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-800 overflow-hidden">
                      ...
                      <div className="py-2">
                        <button
                          ...
                          className="flex items-center w-full px-4 py-3 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
                        >
                ...
                <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-800">
                  ...
                  <div className="space-y-2">
                    ...
                    <button
                      ...
                      className="flex items-center w-full px-4 py-3 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl transition-colors text-left"
                    >
                      <LogOut className="w-4 h-4 mr-3" />
                      Logout
                    </button>
