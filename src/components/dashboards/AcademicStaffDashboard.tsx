...
export function AcademicStaffDashboard({ onNavigate }: AcademicStaffDashboardProps) {
  ...
  // Filter academic feedbacks only for this department
  ...
  return (
    <Layout title={`Academic Staff Dashboard - ${user?.name}`}>
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{departmentFeedbacks.length}</div>
            </CardContent>
          </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Review and respond to academic feedback from students
            </CardDescription>
          </CardHeader>
          <CardContent>
